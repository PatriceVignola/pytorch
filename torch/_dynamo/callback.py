...
class CompilationCallbackHandler:
    ...
    __prevent_duplicate_callbacks: Optional[bool] = field(default=None, init=False, repr=False)
    ...
    def prevent_duplicate_callbacks(self) -> bool:
        if (self.__prevent_duplicate_callbacks is None):
            self.__prevent_duplicate_callbacks = justknobs_check("pytorch/dynamo:prevent_duplicate_callbacks")
